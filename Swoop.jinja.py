...
Swoop IR is also tree-structures and closely resembles the Eagle file's
structure.  In many respects the Swoop IR is a straightforward conversion
...
A Swoop IR object is a tree of :class:`EagleFilePart` objects.  There is
...
The classes that Swoop IR uses fall into several categories:

 1. **The base class** :class:`EagleFilePart` is the baseclass for all other classes in the Swoop IR.
...
The code for Swoop IR is autogenerated by a Python script called
:code:`GenerateSwoop.py`.
