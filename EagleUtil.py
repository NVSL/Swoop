...
def make_package (
    ...
    package.extend(drawingElements)
...
def get_drawingElements (root):
    drawingElements = []
    
    drawingElements += root.findall("./wire")
    drawingElements += root.findall("./rectangle")
    drawingElements += root.findall("./text")
    drawingElements += root.findall("./circle")
